...
$zipPath = Join-Path $distRoot "openclaw-zombie-director-cloud-linux-dedicated-remote-openclaw.zip"
$stagingRoot = Join-Path $env:TEMP "ocd-cloud-bundle-stage-linux"
